...
export class Dashboard {
  ...
  constructor(page: Page) {
    ...
    this.baseLanguageControl = page.locator(Dashboard.select2Selector, {
      hasText: "English",
    });
    this.targetLanguageControl = page.locator(Dashboard.select2Selector, {
      hasText: "Select...",
    });
  ...
  private async setBaseLanguage(baseLanguage?: string, languageCode?: string) {
    ...
    await this.page.click(
      `text='${baseLanguage || "Russian"} (${languageCode || "ru"})'`
    );
  }

  private async setTargetLanguage(
    ...
    await this.page.click(
      `text='${targetLanguage || "English"} (${languageCode || "en"})'`
    );
  }
}
